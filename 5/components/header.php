             ...
             <div class="row h-45px align-items-center m-0">
                 <div class="col-12 col-lg-7 fw-500 justify-content-lg-start justify-content-center">
                     <span class="me-25px fs-15 md-m-0">
                         <i class="feather icon-feather-phone-call text-base-color me-10px">
                         </i>
                         <span
                             class="text-light-gray">Phone: 1 800 222 000 - Any time 24/7</span>
                     </span>
                     <span class="d-xl-inline-block d-none fs-15">
                         <i
                 ...
                 <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                     <ul class="navbar-nav">
                         ...
                         <li class="nav-item dropdown dropdown-with-icon-style02">
                             <a href="<?php echo SERVICES ?>" class="nav-link">Services</a>
                             <i class="fa-solid fa-angle-down dropdown-toggle" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                             </i>
                     ...
                     <div class="header-button ms-25px">
                         <a href="demo-logistics-contact-us.html"
                             ...
                             <span>
                                 ...
                                 <span class="btn-icon">
                                     <i class="feather icon-feather-mail">
                                     </i>
                                 </span>
                             </span>
                         </a>
