...
<section>
    <div class="container">
        <div class="row">
            <div class="col-lg-5 md-mb-40pxx" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 250, "easing": "easeOutQuad" }'>
                <div class="position-sticky top-120px md-top-0px md-position-relative">
                    <span class="fs-16 lh-22 fw-700 mb-15px d-inline-block text-uppercase text-dark-gray border-bottom border-2 border-color-base-color">Get to know us</span>
                    <h2 class="text-dark-gray mb-20px fw-700 ls-minus-1px">Contact our offices around the world.</h2>
                        ...
                        <div class="row g-0 box-shadow-quadruple-large border-radius-6px overflow-hidden">
                            ...
                            <div class="col-lg-6 col-sm-6 bg-white box-shadow-extra-large p-30px">
                                <div class="services-box-content last-paragraph-no-margin">
                                    <span class="d-block text-dark-gray fw-700 fs-19 mb-10px">Ilorin</span>
                                    <p>
                                        Charlie B Building,
                                        <br>
                                        Opp. Sobi Specilaist Hospital
                                        <br>
                                        Alagbado Area, llorin,
                                        <br>
                                        Kwara, NIGERIA
                                    </p>
...
<section class="p-0 d-none">
    <div class="container-fluid p-o">
        <div class="row g-0 justify-content-center">
            <div class="col-12">
                <div id="map" class="map h-650px sm-h-500px" data-map-options='{ "lat": -37.805688, "lng": 144.962312, "style": "Silver", "marker": { "type": "HTML", "color": "#ffc700" }, "popup": { "defaultOpen": false, "html": "<div class=infowindow><strong class=\"mb-3 d-inline-block \">Crafto Logistics</strong><p>16122 Collins street, Melbourne, Australia</p></div><div class=\"google-maps-link\"> <a aria-label=\"View larger map\" target=\"_blank\" jstcache=\"31\" href=\"https://maps.google.com/maps?ll=-37.805688,144.962312&amp;z=17&amp;t=m&amp;hl=en-US&amp;gl=IN&amp;mapclient=embed&amp;cid=13153204942596594449\" jsaction=\"mouseup:placeCard.largerMap\">VIEW LARGER MAP</a></div>" } }'></div>
            </div>
        </div>
    </div>
</section>
...
<!-- start section -->
<section>
    <div class="container overlap-sectionoverlap-section-three-fourth" data-anime='{"el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 800, "delay": 500, "staggervalue": 150, "easing": "easeOutQuad" }'>
                ...
                <div class="bg-very-light-gray p-8 border-radius-10px">
                    ...
                    <form action="email-templates/contact-form.php" method="post" class="row contact-form-style-01">
                        ...
                        <div class="col-xl-5 col-md-5 text-center text-md-end sm-mt-20px">
                            ...
                            <button class="btn btn-large btn-dark-gray btn-box-shadow btn-round-edge btn-switch-text left-icon submit" type="submit">
                                <span>
