            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
              <div class="footer-widget wow fadeInUp" data-wow-delay=".1s">
                ...
                <div class="footer-text">
                  <p>
                    Protadec is an indigenous
                    Engineering Construction Company that is duly registered and
                    authorized to carry out Engineering Construction Works in the
                    areas of Civil, Bridges, Roads & Highways, Structures/Building,
                    Drainage and general turnkey contracts.
                  </p>
                </div>
                <div class="award-logo-area">
                  <div class="award-logo">
                    <img src="admin/assets/images/footer/award-logo-1.webp" alt="">
                  </div>
                  <div class="award-logo">
                    <img src="admin/assets/images/footer/award-logo-2.webp" alt="">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-12">
              <div class="copyright-content-area">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="mailto:info@bexon.com">
                        ...
                        <span class="text">info@protadec.com</span>
                      </a>
                    </li>
                  </ul>
                </div>
                ...
                <div class="copyright-text">
                  <p>&copy; 2025
                    <a href="#" target="_blank">Potradec</a>
                    All right reserved
                  </p>
                </div>
              </div>
